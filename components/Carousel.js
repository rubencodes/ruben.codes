...
const scrollToPage = (scrollArea, page, {
	isScrolling,
	setIsScrolling,
	immediate = false,
}) => {
...
const Carousel = ({
	...
	const pagedImages = useMemo(() => arrayToChunks(images, pageSize), [images, pageSize]);
	...
	const ArrayNavigator = useArrayNavigator(currentPage, setCurrentPage, pageCount);
