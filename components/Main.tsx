      ...
      {activeSection === SectionType.About && (
        <Section>
          ...
          <p className="text light">
            ...
            to do their jobs most effectively. I&apos;ve had the opportunity to
            work on several major projects during my time at OkCupid, including
            a major refactor of the Desktop and Mobile Web platforms from a
            legacy home-rolled static HTML framework into a React-based Single
            Page App. I&apos;ve also converted major chunks of application logic
            to TypeScript, added Honeycomb tracing to our frontend and API, and
            added end-to-end test coverage using Cypress, all of which resulted
            in significant improvements to developer productivity and reductions
            in overall downtime. Previously, I worked at{" "}
            <ExternalLink className="text-green-600" to="https://slack.com">
              Slack
            </ExternalLink>
            , building data visualizations for our enterprise customers to help
            them understand how best to take advantage of the Slack product.
            Prior to that, I was employee #2 at{" "}
            ...
            like to get to know more about me, check out the rest of my site, or
            reach out via email or{" "}
            <ExternalLink
              className="text-blue-900"
              to="https://linkedin.com/in/rubencodes"
            >
              LinkedIn
            </ExternalLink>
            .
