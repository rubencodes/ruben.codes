...
const PhotoGridItemButton = ({ buttonStyle, ...props }) => <button className={buttonStyle} {...props} />;
...
export const PhotoGrid = ({
	...
	const renderButtons = isEditMode ? ({ buttonStyle, imageInfo }) => (
		<>
			<PhotoGridItemMoveButton buttonStyle={buttonStyle}>
				<Icon type="arrows-alt" />
			</PhotoGridItemMoveButton>
			<PhotoGridItemButton buttonStyle={buttonStyle} onClick={() => onImageResize(imageInfo)}>
				<Icon type="arrows-alt-h" />
			</PhotoGridItemButton>
			<PhotoGridItemButton buttonStyle={buttonStyle} onClick={() => onImageRemove(imageInfo)}>
				<Icon type="times" />
			</PhotoGridItemButton>
		</>
	) : null;
