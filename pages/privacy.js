...
const Home = () => (
  <>
    ...
    <main className={classnames("page", styles.resumeContainer)}>
      ...
      <p>
        One of our main priorities is the privacy of our users. This Privacy
        Policy document contains types of information that is collected by and
        recorded by ruben.codes and our products, and how we use it.
      </p>
      ...
      <p>
        ...
        for visitors to our website and users of our apps with regards to the
        information that they shared. This policy is not applicable to any
        information collected offline or via channels other than this website or
        our apps.
      </p>
      ...
      <p>
        By using our products, you hereby consent to our Privacy Policy and
        agree to its terms.
      </p>
      ...
      <ul>
        ...
        <li>
          ...
          information relating to our products, and for marketing and
      ...
      <p>
        ...
        advertising partners of ruben.codes.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on ruben.codes, which are sent
      ...
      <p>
        Note that ruben.codes has no access to or control over these cookies
      ...
      <p>
        ruben.codes's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        ruben.codes does not knowingly collect any Personal Identifiable
