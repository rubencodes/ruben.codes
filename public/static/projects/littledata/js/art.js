...
$("#toggle").click(function () {
  ...
  $righty.animate({
    right:
      parseInt($righty.css("right"), 10) == -2 ? -$righty.outerWidth() : -2,
  });
  $(this).animate({
    right:
      parseInt($righty.css("right"), 10) == -2 ? -2 : $righty.outerWidth() - 4,
  });
});
...
navigator.getUserMedia(
  ...
  function () {
    alert(
      "Your browser does not support WebRTC! Download Google Chrome to continue."
    );
  }
);
