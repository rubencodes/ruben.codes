export default {
  ...
  about: `Hi! I'm Ruben. I'm a designer, developer, and artist passionate about building cool stuff. I currently work at OkCupid, in New York City, where I work on the Web Core team, empowering other developers to be productive with the data, tools, and abstractions to do their jobs best. I've got the opportunity to work on several major projects, including reworking the Desktop and Mobile Web site into a Single Page App, rewriting major bits of application logic using TypeScript, and rewriting OkCupid's instant messenger using React. Previously, I worked at Slack, building data visualizations for our enterprise customers to understand how best to take advantage of the Slack platform. Prior to that, I designed and built the Progressive Web App for WELL Health Inc, a Techstars-funded startup dedicated to improving the patient healthcare experience. I oversaw the rollout of WELL from zero users to several hundred thousand MAU that were being seen in mid-2018. When I'm not working, I love to make art, apps, and sometimes, even furniture. I graduated from Bowdoin College in 2015 with a degree in Computer Science and Visual Arts. That summer, I was selected to attend WWDC as a Student Scholar. I also helped write a book on building Swift apps for WatchOS. For more information about me, feel free to reach out to me via any of the links listed in the sidebar.`,
  info: {
