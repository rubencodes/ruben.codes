export default {
  ...
  about: `Hi! I'm Ruben. I'm a developer, designer, and photographer, who is passionate about building cool stuff. I currently work at OkCupid, in New York City, where I work on the Web Core team, empowering other developers to be productive with the data, tools, and abstractions to do their jobs best. I've had the opportunity to work on several major projects at OkCupid, including reworking the Desktop and Mobile Web platforms into a Single Page App, converting major bits of application logic to TypeScript, and rewriting OkCupid's messaging system using React and GraphQL. Previously, I worked at Slack, building data visualizations for our enterprise customers to understand how best to take advantage of the Slack product. Prior to that, I designed and built the Progressive Web App for WELL Health Inc, a Techstars-funded startup dedicated to improving the patient healthcare experience. I oversaw the rollout of WELL from zero to several hundred thousand MAU. I graduated from Bowdoin College in 2015 with a degree in Computer Science and Visual Arts. That summer, I was selected to attend WWDC as a Student Scholar. I also wrote a book on building Swift apps for WatchOS v1. For more information about me, feel free to reach out to me via any of the links listed in the sidebar.`,
  info: {
